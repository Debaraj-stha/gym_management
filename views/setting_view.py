...
class SettingView(tk.Toplevel):
    ...
    def create_ui(self):
        # Language label
        label = createLabel(self, "Language", bg=self.bg)
        ...
        label = createLabel(self, "Background", bg=self.bg)
        ...
        label = createLabel(self, "Notifications", bg=self.bg)
        ...
        label = createLabel(self, "Theme", bg=self.bg)
